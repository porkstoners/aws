...
""" Ask for input on the parent folder location or use current location as default """  
...
""" If the directory doesn't exist ask the user again """ 
...
""" Execute the tree command to show the user the directory structure """ 
